...
![alt text](test1_T4.png)
![alt text](test2_T4.png)
![alt text](test3_T4.png)
...
class Aleat:
    """
    Clase que implementa un generador de números aleatorios usando el algoritmo LGC.
    ...
    Métodos:
        ...
        __call__(x0): Reinicia la secuencia con una nueva semilla x0.
    ...
    def __init__(self, *, m=2**48, a=25214903917, c=11, x0=1212121):
        """Inicializa los parámetros del generador LGC."""
        self.m = m
        self.a = a
        self.c = c
        self.x = x0
    ...
    def __iter__(self):
        """Permite que el objeto sea tratado como un iterable."""
        return self

    def __next__(self):
        """Aplica la fórmula x_n+1 = (a*x_n + c) % m y devuelve el resultado."""
        self.x = (self.a * self.x + self.c) % self.m
        return self.x

    def __call__(self, x0):
        """Reinicia la semilla del generador de forma posicional."""
        self.x = x0
...
def aleat(*, m=2**48, a=25214903917, c=11, x0=1212121):
    ...
    while True:
        x = (a * x + c) % m
        # Al usar yield, podemos recibir un valor mediante .send()
        recibido = yield x
